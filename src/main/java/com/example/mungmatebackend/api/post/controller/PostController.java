...
public class PostController {
  ...
  @ApiResponses(value = {
      @ApiResponse(
          ...
          content = @Content(schema = @Schema(implementation = PostDto.PostPutResponse.class))
      ),
      @ApiResponse(
          responseCode = "401",
  ...
  @ApiResponses(value = {
      @ApiResponse(
          ...
          content = @Content(schema = @Schema(implementation = PostDto.PostDeleteResponse.class))
      ),
      @ApiResponse(
          responseCode = "401",
          description = "해당 게시글을 소유한 유저가 아님",
  ...
  public ResponseEntity<PostDto.PostDeleteResponse> deletePost(
      @Parameter(name = "postId", description = "게시글 id")
      @PathVariable Long postId,
      @Parameter(name = "userId", description = "유저 id")
      @PathVariable Long userId) {
